...
export default function CamerasManagementMain() {
  const {
    tab,
    setTab,
    query,
    ...
    isFetching,
    refetch,
  } = useCamerasManagementDashboard({ enableRoi: false });

  return (
    <div className={`min-h-full w-full pb-12 pt-2 text-[#101828] sm:pt-4 ${CRADLE_CANVAS_BG}`}>
