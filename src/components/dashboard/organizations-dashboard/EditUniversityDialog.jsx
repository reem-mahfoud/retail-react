...
export default function EditUniversityDialog({ open, row, onClose, onSave, entityLabel = 'University' }) {
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 id="edit-university-title" className="text-lg font-semibold text-[#101828]">
              Edit {entityLabel.toLowerCase()}
            </h2>
            <p className="mt-1 text-sm text-[#667085]">Update details for this {entityLabel.toLowerCase()}.</p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-[#344054]" htmlFor="uni-edit-name">
              {entityLabel} name
            </label>
            <input
              id="uni-edit-name"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-[#344054]" htmlFor="uni-edit-count">
                Count
              </label>
              <input
                id="uni-edit-count"
            ...
            <div>
              <label className="block text-sm font-medium text-[#344054]" htmlFor="uni-edit-used">
                Used
              </label>
              <input
                id="uni-edit-used"
          ...
          <div>
            <label className="block text-sm font-medium text-[#344054]" htmlFor="uni-edit-total">
              Total
            </label>
            <input
              id="uni-edit-total"
        ...
        <div className="mt-7 flex items-center justify-end gap-3 border-t border-[#F2F4F7] pt-5">
          ...
          <button
            type="button"
            className="rounded-full bg-[#7F56D9] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#6941C6]"
            onClick={() => {
